...
export declare namespace gkebackup_v1 {
    ...
    export class Resource$Projects$Locations$Backupplans {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getTags(params: Params$Resource$Projects$Locations$Backupplans$Gettags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getTags(params?: Params$Resource$Projects$Locations$Backupplans$Gettags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetTagsResponse>>;
        getTags(params: Params$Resource$Projects$Locations$Backupplans$Gettags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getTags(params: Params$Resource$Projects$Locations$Backupplans$Gettags, options: MethodOptions | BodyResponseCallback<Schema$GetTagsResponse>, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
        getTags(params: Params$Resource$Projects$Locations$Backupplans$Gettags, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setTags(params: Params$Resource$Projects$Locations$Backupplans$Settags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setTags(params?: Params$Resource$Projects$Locations$Backupplans$Settags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SetTagsResponse>>;
        setTags(params: Params$Resource$Projects$Locations$Backupplans$Settags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setTags(params: Params$Resource$Projects$Locations$Backupplans$Settags, options: MethodOptions | BodyResponseCallback<Schema$SetTagsResponse>, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
        setTags(params: Params$Resource$Projects$Locations$Backupplans$Settags, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
    ...
    export class Resource$Projects$Locations$Restoreplans {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getTags(params: Params$Resource$Projects$Locations$Restoreplans$Gettags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getTags(params?: Params$Resource$Projects$Locations$Restoreplans$Gettags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetTagsResponse>>;
        getTags(params: Params$Resource$Projects$Locations$Restoreplans$Gettags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getTags(params: Params$Resource$Projects$Locations$Restoreplans$Gettags, options: MethodOptions | BodyResponseCallback<Schema$GetTagsResponse>, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
        getTags(params: Params$Resource$Projects$Locations$Restoreplans$Gettags, callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
        getTags(callback: BodyResponseCallback<Schema$GetTagsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setTags(params: Params$Resource$Projects$Locations$Restoreplans$Settags, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setTags(params?: Params$Resource$Projects$Locations$Restoreplans$Settags, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SetTagsResponse>>;
        setTags(params: Params$Resource$Projects$Locations$Restoreplans$Settags, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setTags(params: Params$Resource$Projects$Locations$Restoreplans$Settags, options: MethodOptions | BodyResponseCallback<Schema$SetTagsResponse>, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
        setTags(params: Params$Resource$Projects$Locations$Restoreplans$Settags, callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
        setTags(callback: BodyResponseCallback<Schema$SetTagsResponse>): void;
        /**
         * Returns permissions that a caller has on the specified resource. If the resource does not exist, this will return an empty set of permissions, not a `NOT_FOUND` error. Note: This operation is designed to be used for building permission-aware UIs and command-line tools, not for authorization checking. This operation may "fail open" without warning.
         * @example

...
export declare namespace apphub_v1alpha {
    ...
    export interface Schema$ServiceProperties {
         ...
         */
        extendedMetadata?: {
            [key: string]: Schema$ExtendedMetadata;
        } | null;
        /**
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getBoundary(params: Params$Resource$Projects$Locations$Getboundary, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getBoundary(params?: Params$Resource$Projects$Locations$Getboundary, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Boundary>>;
        getBoundary(params: Params$Resource$Projects$Locations$Getboundary, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getBoundary(params: Params$Resource$Projects$Locations$Getboundary, options: MethodOptions | BodyResponseCallback<Schema$Boundary>, callback: BodyResponseCallback<Schema$Boundary>): void;
        getBoundary(params: Params$Resource$Projects$Locations$Getboundary, callback: BodyResponseCallback<Schema$Boundary>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateBoundary(params: Params$Resource$Projects$Locations$Updateboundary, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        updateBoundary(params?: Params$Resource$Projects$Locations$Updateboundary, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        updateBoundary(params: Params$Resource$Projects$Locations$Updateboundary, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        updateBoundary(params: Params$Resource$Projects$Locations$Updateboundary, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        updateBoundary(params: Params$Resource$Projects$Locations$Updateboundary, callback: BodyResponseCallback<Schema$Operation>): void;

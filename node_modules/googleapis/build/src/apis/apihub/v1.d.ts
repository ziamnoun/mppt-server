...
export declare namespace apihub_v1 {
    ...
    export class Resource$Projects$Locations$Addons {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Addons$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Addons$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudApihubV1Addon>>;
        get(params: Params$Resource$Projects$Locations$Addons$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Addons$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudApihubV1Addon>, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1Addon>): void;
        get(params: Params$Resource$Projects$Locations$Addons$Get, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1Addon>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Addons$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Addons$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudApihubV1ListAddonsResponse>>;
        list(params: Params$Resource$Projects$Locations$Addons$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Addons$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudApihubV1ListAddonsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1ListAddonsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Addons$List, callback: BodyResponseCallback<Schema$GoogleCloudApihubV1ListAddonsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudApihubV1ListAddonsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        manageConfig(params: Params$Resource$Projects$Locations$Addons$Manageconfig, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        manageConfig(params?: Params$Resource$Projects$Locations$Addons$Manageconfig, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        manageConfig(params: Params$Resource$Projects$Locations$Addons$Manageconfig, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        manageConfig(params: Params$Resource$Projects$Locations$Addons$Manageconfig, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        manageConfig(params: Params$Resource$Projects$Locations$Addons$Manageconfig, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        manageConfig(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    }
